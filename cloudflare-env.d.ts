/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 6e81b6afca1e2160a848e9779e8bb2fc)
// Runtime types generated with workerd@1.20260603.1 2024-12-30 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	PPKPT_CONTENT: KVNamespace;
	PPKPT_IMAGES: R2Bucket;
	ASSETS: Fetcher;
	GITHUB_TOKEN: string;
